...
import { useNotification, useGlobalNotification } from './useNotification'
...
describe('useNotification', () => {
  ...
  it('should update notification', () => {
    ...
    const id = show({ title: 'Original', message: 'Original message', type: 'info' })
  ...
  it('should pause and resume notifications', () => {
    const { notifications, show, pause, resume } = useNotification({ defaultDuration: 5000 })
