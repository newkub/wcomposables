...
describe('useFilter', () => {
  const users: User[] = [
    { id: 1, name: 'Alice Johnson', email: 'alice@example.com', age: 30, active: true, tags: ['admin', 'user'] },
    { id: 2, name: 'Bob Smith', email: 'bob@example.com', age: 25, active: false, tags: ['user'] },
    { id: 3, name: 'Charlie Brown', email: 'charlie@example.com', age: 35, active: true, tags: ['guest'] },
    { id: 4, name: 'Diana Prince', email: 'diana@example.com', age: 28, active: true, tags: ['admin', 'super'] }
  ]
