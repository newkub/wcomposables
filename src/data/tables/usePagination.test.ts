...
describe('usePagination', () => {
  ...
  it('should generate page numbers', () => {
    const { pageNumbers, setTotalItems, setPageSize, goToPage } = usePagination()
  ...
  it('should navigate to pages correctly', () => {
    const { currentPage, goToPage, nextPage, previousPage, firstPage, lastPage } = usePagination({
      currentPage: 1,
      pageSize: 10,
      totalItems: 100
    })
  ...
  it('should reset to initial values', () => {
    const { currentPage, pageSize, totalItems, goToPage, setPageSize, reset } = usePagination({
      currentPage: 2,
      pageSize: 5,
      totalItems: 25
    })
