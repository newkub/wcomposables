...
describe('useSpeechRecognition', () => {
  ...
  it('should initialize with default values', () => {
    const { isSupported, isListening, isPaused, transcript, interimTranscript, error, results } = useSpeechRecognition()
  ...
  it('should handle recognition start event', () => {
    const { start, isListening, isPaused, transcript, interimTranscript, results } = useSpeechRecognition()
  ...
  it('should handle multiple results', () => {
    const { start, transcript, results, interimTranscript } = useSpeechRecognition()
  ...
  it('should handle recognition end event', () => {
    const { start, isListening, isPaused, interimTranscript } = useSpeechRecognition()
  ...
  it('should pause and resume recognition', () => {
    const { start, pause, resume, isListening, isPaused } = useSpeechRecognition()
  ...
  it('should clear all data', () => {
    const { start, clear, transcript, interimTranscript, error, results } = useSpeechRecognition()
