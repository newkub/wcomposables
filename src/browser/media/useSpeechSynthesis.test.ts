...
describe('useSpeechSynthesis', () => {
  ...
  it('should initialize with default values', () => {
    const { isSupported, isSpeaking, isPaused, isFinished, error, speechText } = useSpeechSynthesis()
  ...
  it('should use custom options', () => {
    const { speechText, speechPitch, speechRate, speechVolume, speechLang } = useSpeechSynthesis({
      text: 'Hello world',
      pitch: 1.5,
      rate: 0.8,
      volume: 0.5,
