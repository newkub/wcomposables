...
describe('usePermission', () => {
  ...
  it('should handle geolocation permission denial', async () => {
    mockGetCurrentPosition.mockImplementation((_success, error) => {
      const positionError = new Error('Permission denied') as unknown as GeolocationPositionError
  ...
  it('should provide computed properties', async () => {
    const { isGranted, isDenied, isPrompt, queryPermission } = usePermission('geolocation')
