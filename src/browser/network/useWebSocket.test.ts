...
describe('useWebSocket', () => {
  ...
  it('should initialize with default values', () => {
    const { isConnected, isConnecting, error, lastMessage, messageHistory, reconnectAttempts } = useWebSocket({
  ...
  it('should get messages by type', () => {
    ...
    mockWebSocket.onmessage({ data: '{"type": "notification", "message": "alert"}' })
  ...
  it('should get messages in time range', () => {
    ...
    const rangeMessages = getMessagesInTimeRange(_midTime - 500, _midTime + 500)
  ...
  it('should use custom protocols', () => {
    ...
    expect(WebSocket).toHaveBeenCalledWith('ws://localhost:8080', ['chat', 'notification'])
  })
