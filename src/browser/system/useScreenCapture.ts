...
export function useScreenCapture(options: ScreenCaptureOptions = {}) {
  ...
  const startCapture = async (displayMediaOptions?: DisplayMediaStreamOptions): Promise<boolean> => {
  ...
  const toggleCapture = async (options?: DisplayMediaStreamOptions): Promise<boolean> => {
